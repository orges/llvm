...
set_target_properties(clangIndexDataStore PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_MINSIZEREL "CXX"
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/lib/libclangIndexDataStore.a"
  )

list(APPEND _IMPORT_CHECK_TARGETS clangIndexDataStore )
list(APPEND _IMPORT_CHECK_FILES_FOR_clangIndexDataStore "${_IMPORT_PREFIX}/lib/libclangIndexDataStore.a" )
...
set_target_properties(clangTesting PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_MINSIZEREL "CXX"
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/lib/libclangTesting.a"
  )
...
set_target_properties(clang PROPERTIES
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/bin/clang-13"
  )
...
set_target_properties(clang-offload-wrapper PROPERTIES
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/bin/clang-offload-wrapper"
  )
...
set_target_properties(IndexStore PROPERTIES
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/lib/libIndexStore.so.13git"
  IMPORTED_SONAME_MINSIZEREL "libIndexStore.so.13git"
  )

list(APPEND _IMPORT_CHECK_TARGETS IndexStore )
list(APPEND _IMPORT_CHECK_FILES_FOR_IndexStore "${_IMPORT_PREFIX}/lib/libIndexStore.so.13git" )
...
set_target_properties(clang-cpp PROPERTIES
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/lib/libclang-cpp.so.13git"
  IMPORTED_SONAME_MINSIZEREL "libclang-cpp.so.13git"
  )
...
set_target_properties(libclang PROPERTIES
  IMPORTED_LOCATION_MINSIZEREL "${_IMPORT_PREFIX}/lib/libclang.so.13"
  IMPORTED_SONAME_MINSIZEREL "libclang.so.13git"
  )
